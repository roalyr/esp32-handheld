...
CONTEXT: Project: ESP32-S3-N16-R8 handheld terminal with T9 keyboard and coding | Stack: C++, PlatformIO
TASK:
...
- TECHNICAL_CONSTRAINTS: [e.g. Memory limits]
- ATOMIC_TASKS:
...
2. Add strict types and docstrings.
