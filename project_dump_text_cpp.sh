...
# Default values
INPUT_DIR="."
OUTPUT_FILE="PROJECT_DUMP_TEXT_CPP.txt" # Default output, will be excluded
FILE_EXTENSION="cpp" # Default file extension
EXCLUDE_WORDS=()
EXCLUDE_DIRS=(".git", ".pio" ) # Exclude .git by default
ADD_SEPARATOR=true
