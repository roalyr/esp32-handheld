// [Revision: v2.1] [Path: src/config.h] [Date: 2025-12-10]
// Description: Global hardware definitions. Added DEFAULT_CONTRAST.
...
#define DEFAULT_CONTRAST 10     // Global default contrast (0-255)
